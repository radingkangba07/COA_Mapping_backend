...
class ItemProfileRunRepository:
    ...
    async def create_run(self, project_id: UUID, started_at: datetime) -> ItemProfileRun:
        run = ItemProfileRun(project_id=project_id, status="ingesting", started_at=started_at)
