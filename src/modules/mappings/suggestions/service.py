...
def _merge(suggestion: CoaMappingSuggestion, mapping: CoaMapping | None) -> dict:
    ...
    if mapping is None:
        return {
            ...
            "source_account_number": suggestion.source_account_number,
            "source_name": suggestion.source_account_name or "",
            "source_type": suggestion.source_account_type or "",
            "target_account_number": suggestion.target_account_number,
    ...
    return {
        "id": str(mapping.id),
        "suggestion_id": str(suggestion.id),
        "source_account_number": mapping.source_account_number or suggestion.source_account_number,
        ...
        "target_account_number": mapping.target_account_number or suggestion.target_account_number,
            ...
            groups[key].append(
                {
                    ...
                    "source_account_number": merged["source_account_number"],
                    "source_name": merged["source_name"],
                    "target_account_number": merged["target_account_number"],
